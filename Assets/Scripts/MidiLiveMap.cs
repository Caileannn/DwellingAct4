...
public class MidiLiveMap : MonoBehaviour
{
    ...
    public float f_PRatio = 5f;
    public float f_PGravity = 1f;
    public float f_PFreq = 5f;
    public float f_PTurb = 2f;
    ...
    void SetupVFXTest()
    {
            ...
            // Points 
            m_VFX.SetFloat(m_PLifeMin, (f_PLifeMin * m_PotIn[1]) + 0.1f);
            m_VFX.SetFloat(m_PLifeMax, (f_PLifeMax * m_PotIn[2]) + 1f);
            ...
            m_VFX.SetVector3(m_PGravity, new Vector3(0f, m_SliderIn[7] * -9.8f, 0f));
